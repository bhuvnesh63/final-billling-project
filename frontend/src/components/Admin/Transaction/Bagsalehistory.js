...
const SaleOrderHistory = "http://localhost:4000/api/v1/bagsalehistories"

const BagSaleHistory = ({ items }) => {
    ...
    const handleSearch = (id) => {
        // console.log(id)
        axios.get(`http://localhost:4000/api/v1/bagsalehistory/${startDate}/${endDate}`).then(response => {
            setGetpurchase(response.data)
    ...
    const groupItemsByCustomer = () => {
        const groupedItems = {};
        if (getpurchase && getpurchase.bagsale_history) {
            getpurchase.bagsale_history.forEach((saleHistoryItem) => {
                const { customerName, createdDate, mobileNumber, totalAmount, payableAmount, remainingAmount } = saleHistoryItem;
        ...
        <>
            ...
            <Container className='main-col' >
                <Table striped bordered hover className='main-table'>
                    <thead>
                        <tr>
                            <th><h5><AiFillDashboard /> &nbsp; Dashboard/ Unit Sale History</h5></th>
                        </tr>
                    </thead>
                </Table>
                <Row>
            ...
            <div className='form-div' >
                <h5 className="w3-center w3-flat-midnight-blue w3-padding-48 w3-border-blue-grey w3-grey text text-center mb-5 mt-3">Unit Sale History</h5>
